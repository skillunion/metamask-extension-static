({
    ...
    _uniqueClass: '.nonorg-widget-2',
    _buttonHtmlString: '<button class=\"widget-button btn-flat share no-text btn-icon nonorg-widget-2\" style=\"background-color: #08c;color: #fff;\">Add to NonOrg</button>',
